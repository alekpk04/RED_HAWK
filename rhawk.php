                ...
                if ($wp_version != "")
                  {
                    ...
                    if (strpos($vuln_json, "The page you were looking for doesn't exist (404)") !== false)
                      {
                        echo $red . "[!] Seems like the version detection messed up preety bad! Please report here: https://github.com/alekpk04/RED_HAWK/issues/new\n";
                      }
                    else
                      {
            ...
            if ($latestversion > $rhversion)
              {
                ...
                echo $bold . $white . "    Link: https://github.com/alekpk04/RED_HAWK\n\n" . $cln;
              }
